...
def extract_features(frame, region):
    ...
    Parameters:
        frame (numpy.ndarray): The full frame from the video.
    ...
    corners = cv2.goodFeaturesToTrack(gray_roi, maxCorners=max_corners, 
    ...
    if corners is None or len(corners) == 0:
        ...
        corners = cv2.goodFeaturesToTrack(gray_roi, maxCorners=50, 
